...
path = './graph/{}_{}_{}_{}.json'
img_path = './img/{}_{}_{}_{}'
# path = './graph/unet_cuda_front_512_3_42.json'
for i in range(4):
    with open(path.format(args.model, args.target, 'front', i), "r") as json_file:
        json_graph = json.load(json_file)
        show_graph(json_graph, img_path.format(args.model, args.target, 'front', i))
