...
for i in range(4):
    if args.front_build == 1:
        ...
        if True:
            with open(current_file_path + "./src/graph/{}_{}_front_{}.json".format(args.model, args.target, i), "r") as json_graph_front:
                ...
                lib.export_library(current_file_path + "./src/model/{}_{}_front_{}.so".format(args.model, args.target, i))
