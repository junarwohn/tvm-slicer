...
for candi in candidates:
    if len(candi) == 4:
        ...
        if args.name == 'client':
            ...
            print("sleep 3")
            print("python3 client.py", "-f", candi[0], candi[1], "-b", candi[2], ">> client_log.txt")
            print("sleep 3")

            print("python3 client.py", "-f", candi[0], "-b", candi[1], candi[2])
            print("sleep 3")
            print("python3 client.py", "-f", candi[0], "-b", candi[1], candi[2], ">> client_log.txt")
            print("sleep 3")
