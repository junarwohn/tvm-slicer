...
timer_server_total = 0
timer_server_network = 0

timer_server_total_start = time.time()
...
while True:
    ...
    while recv_input_cnt < total_inputs:
        ...
        timer_server_network_start = time.time()
        try:
        ...
        timer_server_network += time.time() - timer_server_network_start
...
timer_server_total += time.time() - timer_server_total_start

print("========================")
print("timer_server_total", timer_server_total)
print("timer_server_network", timer_server_network)
print("timer_server_exclude network", timer_server_total - timer_server_network)
print("========================")