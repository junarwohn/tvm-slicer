...
model_path = "../src/model/{}_{}_ori_{}_{}.so".format(args.model, args.target, args.img_size, args.opt_level)
...
# param_path = "../src/model/{}_{}_ori_{}_{}.params".format(args.model, args.target, args.img_size, args.opt_level)
...
cap.release()
np.save("./org.npy", np.array(result))