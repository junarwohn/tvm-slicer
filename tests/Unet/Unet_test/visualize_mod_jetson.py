...
path = "./UNet_M[{}-{}-{}-{}]_Q[{}]_S[{}]_jetson.json".format(*model_config, quantization_level, "-".join(partition_points))
img_path = "./UNet_M[{}-{}-{}-{}]_Q[{}]_S[{}]_jetson".format(*model_config, quantization_level, "-".join(partition_points))
