...
def UNet(in_dim, out_dim, num_filter, mutation=[0, 0, 0, 0]):
    ...
    #- mutation-shallow 3
    for i in range(mutation[3]):
        trans_1, num_filter = _mutate_expansion(trans_1, num_filter)
    #-
    ...
    #- mutation-shallow 2
    for i in range(mutation[2]):
        trans_2, num_filter = _mutate_expansion(trans_2, num_filter)
    #-
    ...
    #- mutation-shallow 1
    for i in range(mutation[1]):
        trans_3, num_filter = _mutate_expansion(trans_3, num_filter)
    #-
    ...
    #- mutation-shallow 0
    for i in range(mutation[0]):
        trans_4, num_filter = _mutate_expansion(trans_4, num_filter)
    #-
