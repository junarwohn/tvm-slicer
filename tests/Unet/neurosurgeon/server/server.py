...
model_path = "../src/model/{}_{}_back_{}_{}.so".format(args.model, args.target, args.img_size, args.partition_point)
back_lib = tvm.runtime.load_module(model_path)
back_model = graph_executor.GraphModule(back_lib['default'](dev))

model_info_path = "../src/graph/{}_{}_back_{}_{}.json".format(args.model, args.target, args.img_size, args.partition_point)
