...
while (cap.isOpened()):
    ...
    print(dets)    
    for d in dets:
        user_encode_data = json.dumps(d, cls=npEncoder)
        print(len(user_encode_data))
    # print("dets", len(dd.tobytes()), dd.shape)
    # print(dets)
    # print(dets == np.frombuffer(dd.tobytes(), np.float32).reshape(dd.shape))
